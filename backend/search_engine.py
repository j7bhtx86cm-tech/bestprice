...
GUARD_CONFLICTS = {
    ...
    # Pasta shape conflicts (CRITICAL - prevent пенне ↔ спагетти)
    'спагетти': {'пенне', 'фузилли', 'фарфалле', 'ригатони', 'тальятелле', 'феттучине', 'паппарделле'},
    'пенне': {'спагетти', 'фузилли', 'фарфалле', 'тальятелле', 'феттучине'},
    'ригате': {'спагетти', 'фузилли'},  # ригате - тип пенне
    'фузилли': {'спагетти', 'пенне', 'ригатони'},
    'фарфалле': {'спагетти', 'пенне'},
    'ригатони': {'спагетти', 'фузилли'},
    'тальятелле': {'спагетти', 'пенне'},
    'феттучине': {'спагетти', 'пенне', 'тальятелле'},
    'паппарделле': {'спагетти'},
}
