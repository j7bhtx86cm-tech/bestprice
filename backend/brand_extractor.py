...
KNOWN_BRANDS = {
    ...
    # Additional brands found in data (2026-01-06)
    'санфил': 'sanfil',
    'боярин': 'boyarin',
    'бояринъ': 'boyarin',
    'подворье': 'podvorye',
    ...
    'culinaria': 'culinaria',
    'кулинария': 'culinaria',
    'prime foods': 'primefoods',
    'праймфудс': 'primefoods',
    'defa': 'defa',
    'дефа': 'defa',
    'globus': 'globus',
    'глобус': 'globus',
    'gourmet partners': 'gourmetpartners',
    'гурмэ': 'gourmet',
    'qumpro': 'qumpro',
    'nutrilak': 'nutrilak',
    'нутрилак': 'nutrilak',
...
NON_BRAND_WORDS = {
    ...
    'il', 'prb', 'хэ', 'pro', 'россия', 'china', 'китай', 'таиланд', 'вьетнам',
    'италия', 'испания', 'германия', 'франция', 'чили', 'индия', 'usa', 'сша',
    'мурманск', 'черноморск', 'импорт', 'заморозка', 'охлажд', 'с/м', 'см',
    'порционный', 'порционная', 'порционное', 'классический', 'традиционный',
    'оригинальный', 'натуральный', 'цветочный', 'минеральная', 'газированная',
    'безалкогольный', 'безалкогольная', 'без', 'сахара', 'штучн', 'красный',
    'белый', 'черный', 'зеленый', 'желтый', 'копчен', 'соленый', 'сушеный',
}
