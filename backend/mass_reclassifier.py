...
CLASSIFICATION_RULES = [
    ...
    {'pattern': r'пять.*перц|five.*pepper|смесь.*перц', 'super_class': 'condiments.spice_mix.five_pepper', 'priority': 96},
    {'pattern': r'приправ.*моркови|приправ.*по-корейски|korean.*seasoning', 'super_class': 'condiments.seasoning', 'priority': 96},
    {'pattern': r'приправ.*плова|pilaf.*seasoning', 'super_class': 'condiments.seasoning.pilaf', 'priority': 96},
