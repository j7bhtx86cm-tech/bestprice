...
COUNTRY_PATTERNS = {
    # Россия и СНГ
    'РОССИЯ': ['россия', 'рф', 'russian', 'russia', 'российск', 'отечествен', 'росс.', 'рос.'],
    'БЕЛАРУСЬ': ['беларус', 'белорус', 'belarus', 'белоруссия', 'бел.', 'белорусск'],
    'КАЗАХСТАН': ['казахстан', 'kazakhstan', 'казах', 'казахск'],
    'УКРАИНА': ['украин', 'ukraine', 'укр.', 'украинск'],
    'УЗБЕКИСТАН': ['узбекистан', 'uzbekistan', 'узбек', 'узбекск'],
