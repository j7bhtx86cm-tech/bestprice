...
### Phase 18 - NPC Matching v9.2 "Нулевой мусор" — 26 января 2026

**Задача (P0)**: ТЗ v9.2 — жёсткие формы/вид/разделка/упаковка

#### HARD-атрибуты (Strict 1-в-1):

**1. PROCESSING_FORM:**
- `CANNED` ≠ `SMOKED` ≠ `FROZEN_RAW` ≠ `CHILLED`
- ✅ "Скумбрия ж/б в масле" → НЕ "Скумбрия х/к"

**2. CUT_TYPE:**
- `WHOLE` (тушка) ≠ `FILLET` ≠ `STEAK`
- ✅ "Окунь тушка" → НЕ "Окунь филе"

**3. SPECIES:**
- окунь ≠ сибас ≠ тилапия ≠ скумбрия
...
- state: raw ≠ blanched ≠ cooked
- form: peeled ≠ shell_on, headless ≠ head_on
- ✅ "Креветки 16/20" → НЕ "Креветки 31/40"

**6. SIZE RANGE (35% tolerance):**
- ✅ "Окунь 255-311г" → НЕ "Окунь 150-200г"

#### Тесты:
- 64 unit-тестов прошли
- 18 регрессионных тестов ТЗ v9.2
